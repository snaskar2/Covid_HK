...
df_age["Local with Epi-link"] =(df_age['Delay']["Epidemiologically linked with local case"]/df_copy_1["Case no."]["Epidemiologically linked with local case"])*100
df_age["Local without Epi-link"] =(df_age['Delay']["Local case"]/df_copy_1["Case no."]["Local case"])*100
df_age["Local"] =(df_age['local']/df_copy_1["local"])*100
